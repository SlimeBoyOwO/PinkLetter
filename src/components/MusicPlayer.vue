...
<template>
  <div
    ...
    <div class="hidden md:flex flex-col items-center justify-end h-full mt-20 gap-8 animate-float"
      style="animation-delay: 1s">
      <!-- Bunch of Balloons -->
      <svg viewBox="0 0 100 150" class="w-24 h-32 drop-shadow-md pb-4">
        <!-- strings -->
        <path d="M 50 120 L 50 70 M 50 120 L 30 60 M 50 120 L 70 60" stroke="#cbd5e1" stroke-width="1.5" fill="none" />
        <!-- balloon 1 -->
        ...
        <!-- highlights -->
        <path d="M 25 30 Q 30 25 35 30" stroke="rgba(255,255,255,0.6)" stroke-width="2" fill="none"
          stroke-linecap="round" />
        <path d="M 65 35 Q 70 30 75 35" stroke="rgba(255,255,255,0.6)" stroke-width="2" fill="none"
          stroke-linecap="round" />
        <path d="M 45 15 Q 50 10 55 15" stroke="rgba(255,255,255,0.6)" stroke-width="2" fill="none"
          stroke-linecap="round" />
      </svg>

      <!-- Sleeping Cute Pink Pig -->
      <svg viewBox="0 0 100 80" class="w-32 h-24 drop-shadow-lg transform -rotate-6">
        <!-- plump body -->
        <ellipse cx="55" cy="55" rx="28" ry="20" fill="#fbcfe8" />

        <!-- curly tail -->
        <path d="M 80 50 Q 90 45 85 38 Q 80 32 88 30" fill="none" stroke="#fbcfe8" stroke-width="3"
          stroke-linecap="round" />

        <!-- back leg -->
        <ellipse cx="65" cy="70" rx="6" ry="5" fill="#fbcfe8" />
        <path d="M 64 71 L 64 75 M 68 71 L 68 75" stroke="#fda4af" stroke-width="1.5" />

        <!-- front paw -->
        <ellipse cx="38" cy="72" rx="6" ry="5" fill="#fbcfe8" />
        <path d="M 37 73 L 37 77 M 41 73 L 41 77" stroke="#fda4af" stroke-width="1.5" />

        <!-- head -->
        <circle cx="32" cy="50" r="16" fill="#fbcfe8" />

        <!-- floppy ears -->
        <path d="M 20 42 Q 10 32 15 48 Z" fill="#fbcfe8" />
        <path d="M 42 40 Q 52 28 46 45 Z" fill="#fbcfe8" />

        <!-- inner ears -->
        <path d="M 19 43 Q 12 35 16 46 Z" fill="#fce7f3" />
        <path d="M 41 41 Q 48 32 44 44 Z" fill="#fce7f3" />

        <!-- snout -->
        <ellipse cx="25" cy="55" rx="7" ry="5" fill="#f472b6" />
        <!-- nostrils -->
        <ellipse cx="23" cy="55" rx="1.5" ry="2" fill="#be185d" />
        <ellipse cx="27" cy="55" rx="1.5" ry="2" fill="#be185d" />

        <!-- sleepy eyes -->
        <path d="M 22 47 Q 25 49 27 47" fill="none" stroke="#831843" stroke-width="1.5" stroke-linecap="round" />
        <path d="M 31 48 Q 33 50 35 48" fill="none" stroke="#831843" stroke-width="1.5" stroke-linecap="round" />

        <!-- Zzz text -->
        <text x="15" y="25" fill="#f472b6" font-family="sans-serif" font-weight="bold" font-size="12"
          class="animate-pulse">
          Z
        </text>
        <text x="27" y="15" fill="#f472b6" font-family="sans-serif" font-weight="bold" font-size="10"
          class="animate-pulse" style="animation-delay: 0.5s">
          z
        </text>
        <text x="37" y="10" fill="#f472b6" font-family="sans-serif" font-weight="bold" font-size="8"
    ...
    <div class="flex flex-col items-center gap-6">
      <div
        ...
        <div
          ...
          <div
            ...
            <div class="w-3 h-3 bg-slate-300 rounded-full border border-slate-400 absolute top-0 -right-1.5"></div>
            <div class="w-1.5 h-20 bg-slate-300 absolute top-1 right-0 rounded-b-full"></div>
            <div class="w-5 h-6 bg-pink-headband absolute bottom-0 -right-1.5 rounded shadow border border-pink-400">
            </div>
          </div>
        </div>
      ...
      <p class="text-slate-500 font-sans tracking-wide text-sm font-bold flex items-center justify-center gap-2"></p>
    </div>

    <!-- RIGHT SIDE DECORATIONS & TEXT -->
    <div class="hidden md:flex flex-col items-start justify-center h-full mt-14 gap-8 animate-float"
      style="animation-delay: 0.5s">
      <div class="flex items-end gap-2 lg:pl-6">
        <Heart fill="#ff9fb0" class="text-pink-100 drop-shadow-md w-10 h-10 transform rotate-12 mb-4" />
        ...
        <svg viewBox="0 0 100 120" class="w-24 h-28 drop-shadow-lg transform -rotate-3">
          ...
          <path d="M 50 10 Q 53 20 50 22 Q 47 20 50 10 Z" fill="#FFD700" class="animate-pulse"
            style="animation-delay: 0.3s" />
          <path d="M 68 20 Q 71 30 68 32 Q 65 30 68 20 Z" fill="#FFD700" class="animate-pulse"
      ...
      <div
        ...
        <h4 class="font-sans font-bold text-base text-slate-700 mb-2">猪猪の · 生日歌</h4>
        <p class="font-handwriting text-slate-500 text-lg leading-relaxed mb-4">
          过生日的人无论如何都得听到生日歌！嘻嘻交互后自动播放给你！
        </p>
